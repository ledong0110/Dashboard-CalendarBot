...
const our_api = {
  ...
  getCalendarEvents: async (token) => {
    try {
      return await axios({
        method: "get",
        url: serverUrl + "/api/googleSecure/calendar",
        headers: {
          Authorization: "Bearer " + token,
        },
      });
  ...
  checkInfo: async (token) => {
    try {
      return await axios({
        method: "get",
        url: serverUrl + "/api/googleSecure/infoSetting",
        headers: {
          Authorization: "Bearer " + token,
        },
      });
  ...
  postTelegramUsername: async (token, telegram)=> {
    try {
      return await axios({
        method: "post",
        url: serverUrl + "/api/googleSecure/telegram",
        headers: {
          Authorization: "Bearer " + token,
        },
        data: {
